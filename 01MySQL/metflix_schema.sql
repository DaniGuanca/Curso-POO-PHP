/*
BASE DE DATOS DE LA APLICACION TIPO NETFLIX
...
TEXT NO ADMITE DEFAULT NI BUSCADOR FULL TEXT
...
Al campo pass lo hago CHAR asi toma los espacios vacios para encriptar todo el pass

PARA BORRAR UNA BD
DROP DATABASE IF EXISTS metflix;

PARA HACER RELACIONES SE USA ESTO (Acordarse de crear la tabla a referir antes):
...
CREATE TABLE movieseries(
    id_imdb CHAR(9) PRIMARY KEY,
    title VARCHAR(80) NOT NULL,
    plot TEXT,
    author VARCHAR(100) DEFAULT 'Pending',
    actors VARCHAR(30) DEFAULT 'Unknown',
...
/*status ENUM('Coming Soon','Release','In Issue','Finished','Canceled') NOT NULL,*/
...
INSERT INTO users (user, email, nombre, birthday, pass, role) VALUES
    ('Dani', 'dany12rp13@gmail.com', "Daniel", "1993-02-11", MD5("dani"), "Admin"),
    ('Usuario', 'usuario@gmail.com', "Usuario normal", "1993-02-11", MD5("usuario"), "User");

/*http://omdbapi.com/*/
INSERT INTO movieseries (id_imdb, title, plot, genres, author, actors, country, premiere, poster, trailer, rating, status, category) VALUES
